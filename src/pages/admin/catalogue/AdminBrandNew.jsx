...
export default function AdminBrandNew() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('/brands', {
      ...
      .then(data => navigate('/admin/catalogue/brands/' + data.id + '/edit', { state: { toast: 'Brand created successfully.' } }))
      ...
      <div style={styles.container}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.actions}>
            ...
            <button type="button" style={styles.btnSecondary} onClick={() => navigate('/admin/catalogue/brands')}>Cancel</button>
          </div>
        </form>
      </div>
    </div>
